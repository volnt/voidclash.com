    ...
    faq: {
      ...
      hostserver: {
        ...
        n5: {
          ...
          description: "<strong>Warning</strong>: Ports are often closed on a router to help prevent unauthorized access to your home network. Opening any additional ports on your router may decrease the overall security of your network. <br><br><strong>Note:</strong> In some situations it may be a firewall on your computer or router that is blocking access. Try temporarily disabling your firewall to make sure this is not the cause of your problems. <br><br><ol><li>1. To use port forwarding first determine the local IP address of the computer.</li><li>2. Open your router configuration.</li><li>3. Once in the router configuration locate the port forwarding settings, often in a section such as Applications & Gaming or Port forwarding.</li></ol><br><br>In single port forwarding you have different fields that need to be completed. Enter the Externet Port and Internet Port enter the port you want to open in both of these fields, so here it is <strong>13737</strong>. Next is the Protocol, which is <strong>UDP</strong>. Next is the To IP address, which is the <strong>IP address</strong> of the computer or networking device this port is being forwarded to on the network. Finally, once all these values have been configured check the Enabled box and click the Save Changes button."
        }
      },
